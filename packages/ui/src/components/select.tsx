    ...
    <SelectPortal>
      <SelectPrimitive.Positioner>
        <SelectPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-60 min-w-32 overflow-y-auto rounded-xl border bg-popover p-1 text-popover-foreground shadow-md transition-all data-[ending-style]:opacity-0 data-[starting-style]:opacity-0",
            className,
          )}
          {...props}
        >
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-lg py-2 pr-8 pl-2.5 text-xs outline-none select-none data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      {...props}
    >
